    ...
    apiSettings: {
      ...
      onResponse(resp) {
        ...
        for (const item of resp.results) {
          let html = `<img class="ui avatar gt-vm" src="${htmlEscape(item.avatar_link)}" aria-hidden="true" alt="" width="16" height="16"><span class="gt-ellipsis">${htmlEscape(item.username)}</span>`;
