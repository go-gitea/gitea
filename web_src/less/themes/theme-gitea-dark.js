...
module.exports.mappings = {
  '$color: rgba(0,0,0,.95)': 'var(--mono-color-100-alpha-90)',
  '$color: rgba(0,0,0,.9)': 'var(--mono-color-100-alpha-90)',
  '$color: rgba(0,0,0,.87)': 'var(--mono-color-100-alpha-87)',
  '$color: rgba(0,0,0,.85)': 'var(--mono-color-100-alpha-85)',
  '$color: rgba(0,0,0,.8)': 'var(--mono-color-100-alpha-80)',
  '$color: rgba(0,0,0,.7)': 'var(--mono-color-100-alpha-70)',
  '$color: rgba(0,0,0,.6)': 'var(--mono-color-100-alpha-60)',
  '$color: rgba(0,0,0,.5)': 'var(--mono-color-100-alpha-50)',
  '$color: rgba(0,0,0,.4)': 'var(--mono-color-100-alpha-40)',
  '$color: rgba(0,0,0,.3)': 'var(--mono-color-100-alpha-30)',
  '$color: rgba(0,0,0,.2)': 'var(--mono-color-100-alpha-20)',
  '$color: rgba(0,0,0,.15)': 'var(--mono-color-100-alpha-15)',
  '$color: rgba(0,0,0,.05)': 'var(--mono-color-100-alpha-5)',
  '$color: rgba(0,0,0,.04);': 'var(--mono-color-100-alpha-4)',
  '$color: rgba(0,0,0,.03)': 'var(--mono-color-100-alpha-6)',
