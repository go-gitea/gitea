...
func (b *Indexer) addUpdate(ctx context.Context, builder *index.Builder, batchWriter catfile.WriteCloserError, batchReader *bufio.Reader, update internal.FileUpdate, repo *repo_model.Repository) error {
...
func (b *Indexer) Index(ctx context.Context, repo *repo_model.Repository, sha string, changes *internal.RepoChanges) error {
	...
	if len(changes.Updates) > 0 {
		gitBatch, err := catfile.NewBatch(ctx, repo.RepoPath())
		if err != nil {
			return err
		}
