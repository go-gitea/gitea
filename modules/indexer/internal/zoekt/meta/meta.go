...
// The returned bool reports whether any index metadata exists yet.
func ReadIndexMetadata(path string) (*IndexMetadata, bool, error) {
	meta := &IndexMetadata{}
	...
	return meta, true, readJSON(metaPath, meta)
}
