...
// Do you want to search for data with a field value of 0, or do you not specify the field in the search options?
...
// Sorry to confuse anyone who has been trapped by this. Maybe we could refactor the design in the future.
