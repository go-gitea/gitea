...
var _ConfAppIni = []byte(`# NEVER EVER MODIFY THIS FILE
...
func ConfAppIni() (*asset, error) {
	...
	info := bindataFileInfo{name: "app.ini", size: 14047, mode: os.FileMode(420), modTime: time.Unix(1480424346, 0)}
