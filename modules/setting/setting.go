...
var (
	...
	SSH = struct {
		...
		EnableAuthorizedKeysBackup bool           `ini:"SSH_ENABLE_AUTHORIZED_KEYS_BACKUP"`
...
please consider changing to GITEA_CUSTOM`)
	...
	SSH.EnableAuthorizedKeysBackup = sec.Key("SSH_ENABLE_AUTHORIZED_KEYS_BACKUP").MustBool(true)
