...
CONTROL_PLANE_MAX_MESSAGE_SIZE = 33MiB
...
DEVCONTAINER_CONFIG_MAX_SIZE = 96KiB
...
`)
	...
	assert.EqualValues(t, 33*1024*1024, Codespace.ControlPlaneMaxSize)
	...
	assert.EqualValues(t, 96*1024, Codespace.DevContainerConfigMaxSize)
...
`)
	...
	assert.EqualValues(t, 32*1024*1024, Codespace.ControlPlaneMaxSize)
}
