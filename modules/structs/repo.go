...
type Repository struct {
	...
	DefaultAllowMaintainerEdit    bool             `json:"default_allow_edits_from_maintainers"`
...
type EditRepoOption struct {
	...
	DefaultAllowMaintainerEdit *bool `json:"default_allow_edits_from_maintainers,omitempty"`
