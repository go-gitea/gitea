...
func NotifyPullRewiewRequest(doer *models.User, issue *models.Issue, reviewer *models.User, isRequest bool) {
	for _, notifier := range notifiers {
		notifier.NotifyPullRewiewRequest(doer, issue, reviewer, isRequest)
	}
}
