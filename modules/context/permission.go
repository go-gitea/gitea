...
func RequireRepoWriter(unitType unit.UnitType) func(ctx *Context) {
	return func(ctx *Context) {
...
func RequireRepoWriterOr(unitTypes ...unit.UnitType) func(ctx *Context) {
	return func(ctx *Context) {
...
func RequireRepoReader(unitType unit.UnitType) func(ctx *Context) {
	return func(ctx *Context) {
...
func RequireRepoReaderOr(unitTypes ...unit.UnitType) func(ctx *Context) {
	return func(ctx *Context) {
		for _, unitType := range unitTypes {
			if ctx.Repo.CanRead(unitType) {
				return
