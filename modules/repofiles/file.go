...
func GetFileResponseFromCommit(repo *models.Repository, commit service.Commit, branch, treeName string) (*api.FileResponse, error) {
...
func GetFileCommitResponse(repo *models.Repository, commit service.Commit) (*api.FileCommitResponse, error) {
	if repo == nil {
	...
	commitTreeURL, _ := url.Parse(repo.APIURL() + "/git/trees/" + commit.TreeID().String())
