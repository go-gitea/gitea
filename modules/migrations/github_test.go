...
func TestGitHubDownloadRepo(t *testing.T) {
	...
	merged1 := time.Date(2019, 11, 12, 21, 39, 27, 0, time.UTC)
	...
	assert.EqualValues(t, []*base.Review{
		...
		},
		{
			...
			CommitID:     "076160cf0b039f13e5eff19619932d181269414b",
			CreatedAt:    time.Date(2019, 11, 12, 21, 38, 0o0, 0, time.UTC),
			State:        base.ReviewStateApproved,
		},
	}, reviews)
	...
	assert.EqualValues(t, []*base.Review{
		{
			...
			CreatedAt:    time.Date(2020, 0o1, 0o4, 0o5, 33, 18, 0, time.UTC),
			State:        base.ReviewStateApproved,
			Comments: []*base.ReviewComment{
				{
					...
					CommitID:  "2be9101c543658591222acbee3eb799edfc3853d",
					PosterID:  81045,
					CreatedAt: time.Date(2020, 0o1, 0o4, 0o5, 33, 0o6, 0, time.UTC),
					UpdatedAt: time.Date(2020, 0o1, 0o4, 0o5, 33, 18, 0, time.UTC),
				},
			},
		},
		{
			...
			ReviewerName: "lunny",
			CommitID:     "2be9101c543658591222acbee3eb799edfc3853d",
			CreatedAt:    time.Date(2020, 0o1, 0o4, 0o6, 0o7, 0o6, 0, time.UTC),
		...
		},
		{
			...
			ReviewerName: "lunny",
			CommitID:     "2be9101c543658591222acbee3eb799edfc3853d",
			CreatedAt:    time.Date(2020, 0o1, 0o4, 11, 21, 41, 0, time.UTC),
			...
			Comments: []*base.ReviewComment{
				{
					...
					PosterID:  81045,
					CreatedAt: time.Date(2020, 0o1, 0o4, 11, 21, 41, 0, time.UTC),
					UpdatedAt: time.Date(2020, 0o1, 0o4, 11, 21, 41, 0, time.UTC),
				},
			},
		},
	}, reviews)
