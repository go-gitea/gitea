...
func RenderLabel(ctx context.Context, label *issues_model.Label) template.HTML {
	...
	if labelScope == "" {
		// Regular label
		s := fmt.Sprintf("<div class='ui label' style='color: %s !important; background-color: %s !important' data-tooltip-content='%s'>%s</div>",
	...
	s := fmt.Sprintf("<span class='ui label scope-parent' data-tooltip-content='%s'>"+
