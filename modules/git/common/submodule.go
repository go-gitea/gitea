...
var _ (service.SubModuleFile) = &SubModuleFile{}
...
// Commit returns the commit this submodule is associated with
func (sf *SubModuleFile) Commit() service.Commit {
	return sf.commit
}

// NewSubModuleFile create a new submodule file
func NewSubModuleFile(c service.Commit, refURL, refID string) service.SubModuleFile {
