...
func (b *catFileBatchLegacy) QueryContent(obj string, handler func(info *CatFileObject, reader io.Reader) error) error {
	...
	contentReader := newCatFileBatchContentReader(b.getBatchContent().respReader, info.Size)
