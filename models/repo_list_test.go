...
func TestSearchRepository(t *testing.T) {
	...
	testCases := []struct {
		...
		{name: "AllPublic/PublicRepositoriesOfUserIncludingCollaborative",
			...
			count: 22},
		{name: "AllPublic/PublicRepositoriesOfUserIncludingCollaborativeAndTemplates",
			opts:  &SearchRepoOptions{Page: 1, PageSize: 10, OwnerID: 15, AllPublic: true, Template: util.OptionalBoolTrue},
			count: 24},
