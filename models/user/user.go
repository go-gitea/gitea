...
func (u *User) getOrganizationCount(ctx context.Context) (int64, error) {
	return db.GetEngine(ctx).Table("org_user").
		Where("uid=?", u.ID).
		Count()
}
...
func (u *User) GetOrganizationCount(ctx context.Context) (int64, error) {
	return u.getOrganizationCount(db.DefaultContext)
}
...
func UpdateUserCols(u *User, cols ...string) error {
	return UpdateUserColsCtx(db.DefaultContext, u, cols...)
}

// UpdateUserColsCtx update user with database context
func UpdateUserColsCtx(ctx context.Context, u *User, cols ...string) error {
	if err := validateUser(u); err != nil {
		return err
	}
