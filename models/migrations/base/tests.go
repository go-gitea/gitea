...
func MainTest(m *testing.M) {
	...
	if !filepath.IsAbs(setting.CustomConf) {
		// FIXME: this logic is different from other tests, it needs an absolute path, need to figure out why
		setting.CustomConf = filepath.Join(setting.AppWorkPath, setting.CustomConf)
	}
