...
func prepareMigrationTasks() []*migration {
	...
	preparedMigrations = []*migration{
		...
		newMigration(336, "Add notification dedupe columns to notification table", v1_27.AddReleaseNotification),
		newMigration(337, "Add ActionRunJobSummary table", v1_27.AddActionRunJobSummaryTable),
	}
	return preparedMigrations
}
