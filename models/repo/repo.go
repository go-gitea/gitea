...
func (repo *Repository) AllowsPulls() bool {
	return repo.CanEnablePulls() && !repo.IsMirror && repo.UnitEnabled(db.DefaultContext, unit.TypePullRequests)
}
...
func (repo *Repository) AllowsIssues() bool {
	...
	return !repo.IsMirror && repo.UnitEnabled(db.DefaultContext, unit.TypePullRequests)
}
