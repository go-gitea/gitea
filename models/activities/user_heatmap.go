...
func GetUserHeatmapDataByUser(ctx context.Context, user *user_model.User, group *group_model.Group, doer *user_model.User) ([]*UserHeatmapData, error) {
	return getUserHeatmapData(ctx, user, nil, group, doer)
}
