...
func TestAccessLevel(t *testing.T) {
	...
	user1 := &User{ID: 2}
	AssertExistsAndLoadBean(t, user1)
	user2 := &User{ID: 4}
	AssertExistsAndLoadBean(t, user2)
	repo1 := &Repository{OwnerID: 2, IsPrivate: false}
	AssertExistsAndLoadBean(t, repo1)
	repo2 := &Repository{OwnerID: 3, IsPrivate: true}
	AssertExistsAndLoadBean(t, repo2)
