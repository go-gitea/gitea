...
func TestGetActionsUserRepoPermission(t *testing.T) {
	...
	repo2 := unittest.AssertExistsAndLoadBean(t, &repo_model.Repository{ID: 2}) // Private, Owner 2
	repo15 := unittest.AssertExistsAndLoadBean(t, &repo_model.Repository{ID: 15}) // Private, Owner 2
	owner2 := unittest.AssertExistsAndLoadBean(t, &user_model.User{ID: 2})
	actionsUser := user_model.NewActionsUser()

	t.Run("SameRepo_Public", func(t *testing.T) {
		// Task 47 belongs to repo 4 (public) in fixtures
