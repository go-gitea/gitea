...
const (
	...
	SearchOrderByStars        db.SearchOrderBy = "num_stars ASC"
	SearchOrderByStarsReverse db.SearchOrderBy = "num_stars DESC"
	SearchOrderByForks        db.SearchOrderBy = "num_forks ASC"
	SearchOrderByForksReverse db.SearchOrderBy = "num_forks DESC"
)
