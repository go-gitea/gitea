...
func GetPaginated(p Paginator) *Context {
	return WithPagination(DefaultContext, p)
}

// WithPagination sets pagination for a database session
func WithPagination(ctx context.Context, p Paginator) *Context {
