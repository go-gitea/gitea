...
// issueSubscriberCond builds the condition for users effectively subscribed to an issue.
// Mirrors CheckIssueWatch / notification recipients:
// explicit issue watchers ∪ participants (incl. author) ∪ repo watchers − explicit unsubscribers.
...
// (explicit watches, participants/author, and repo watchers; excluding explicit unsubscribers).
