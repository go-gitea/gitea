...
func (opts *IssuesOptions) setupSessionNoLimit(sess *xorm.Session) {
	...
	labelsCount := len(opts.LabelIDs)
	if labelsCount > 0 {
		noLabelsIDs := make([]int64, 0, labelsCount)
		hasNoLabel := false
