...
func (b *Batch) Size() int {
	var numIndexOps int
	var numInternalOps int
	b.internal.GetIndexOps().Range(func(_ string, _ *document.Document) bool {
		numIndexOps++
		return true
	})
	b.internal.GetInternalOps().Range(func(_ string, _ []byte) bool {
		numInternalOps++
		return true
	})

	return numIndexOps + numInternalOps
}
