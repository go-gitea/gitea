...
func AddOAuth2DeviceAuthorizationTableAndFixBuiltinNativeApps(_ context.Context, x base.EngineMigration) error {
	...
	if _, err := x.SyncWithOptions(xorm.SyncOptions{IgnoreDropIndices: true}, new(oauth2Application)); err != nil {
		return err
	}
