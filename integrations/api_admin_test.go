...
func TestAPIAdminCreateAndDeleteSSHKey(t *testing.T) {
	...
	keyOwner := db.AssertExistsAndLoadBean(t, &user_model.User{Name: "user2"}).(*user_model.User)
...
func TestAPIListUsers(t *testing.T) {
	...
	assert.True(t, found)
	numberOfUsers := db.GetCount(t, &user_model.User{}, "type = 0")
...
func TestAPIEditUser(t *testing.T) {
	...
	user2 := db.AssertExistsAndLoadBean(t, &user_model.User{LoginName: "user2"}).(*user_model.User)
