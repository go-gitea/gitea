	...
	onGiteaRun(t, func(*testing.T, *url.URL) {
		tests := []struct {
			...
			{"with_key",
				...
				false,
				"# gitea public key\ncommand=\"" + setting.AppPath + " --config=" + util.ShellEscape(setting.CustomConf) + " --work-path=" + setting.AppWorkPath + " serv key-1\",no-port-forwarding,no-X11-forwarding,no-agent-forwarding,no-pty ssh-rsa  user2@localhost\n",
			},
