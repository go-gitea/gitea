	...
	w := &models.Webhook{
		...
		HookEvent: &models.HookEvent{
			...
			HookEvents: models.HookEvents{
				...
				PullRequestLabel:     com.IsSliceContainsStr(form.Events, string(models.HookEventPullRequestAssign)),
				PullRequestMilestone: com.IsSliceContainsStr(form.Events, string(models.HookEventPullRequestAssign)),
