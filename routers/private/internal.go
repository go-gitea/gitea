...
func Routes() *web.Router {
	...
	r.PathGroup("/hook/pre-receive/{owner}/*", func(r *web.RouterPathGroup) {
		r.Post("/<repo_group:*>/<repo>", RepoAssignment, bind(private.HookOptions{}), HookPreReceive)
	})
	r.PathGroup("/hook/post-receive/{owner}/*", func(r *web.RouterPathGroup) {
		r.Post("/<repo_group:*>/<repo>", context.OverrideContext(), bind(private.HookOptions{}), HookPostReceive)
	})
	r.PathGroup("/hook/proc-receive/{owner}/*", func(r *web.RouterPathGroup) {
		r.Post("/<repo_group:*>/<repo>", context.OverrideContext(), RepoAssignment, bind(private.HookOptions{}), HookProcReceive)
	})
	r.PathGroup("/hook/set-default-branch/{owner}/*", func(r *web.RouterPathGroup) {
		r.Post("/<repo_group:*>/<repo>/<branch>", RepoAssignment, SetDefaultBranch)
	})
	r.Get("/serv/none/{keyid}", ServNoCommand)
	r.PathGroup("/serv/command/{keyid}/{owner}/*", func(r *web.RouterPathGroup) {
		r.Get("/<repo_group:*>/<repo>", ServCommand)
	})
