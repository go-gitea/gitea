...
func DeletePackageVersion(ctx *context.Context) {
	...
	ctx.JSONRedirect(setting.AppSubURL + setting.AdminRouterPrefix + "/packages?page=" + url.QueryEscape(ctx.FormString("page")) + "&q=" + url.QueryEscape(ctx.FormString("q")) + "&type=" + url.QueryEscape(ctx.FormString("type")))
}
...
func CleanupExpiredData(ctx *context.Context) {
	...
	ctx.Redirect(setting.AppSubURL + setting.AdminRouterPrefix + "/packages")
}
