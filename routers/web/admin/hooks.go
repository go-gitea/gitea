...
func DefaultOrSystemWebhooks(ctx *context.Context) {
	...
	sys["BaseLink"] = setting.AppSubURL + setting.AdminRouterPrefix + "/hooks"
	sys["BaseLinkNew"] = setting.AppSubURL + setting.AdminRouterPrefix + "/system-hooks"
	if err != nil {
	...
	def["BaseLink"] = setting.AppSubURL + setting.AdminRouterPrefix + "/hooks"
	def["BaseLinkNew"] = setting.AppSubURL + setting.AdminRouterPrefix + "/default-hooks"
	if err != nil {
		ctx.ServerError("GetWebhooksAdmin", err)
		return
	}
...
func DeleteDefaultOrSystemWebhook(ctx *context.Context) {
	...
	ctx.JSONRedirect(setting.AppSubURL + setting.AdminRouterPrefix + "/hooks")
}
