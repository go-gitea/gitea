...
func NewAuthSourcePost(ctx *context.Context) {
	...
	audit.Record(ctx, audit.SystemAuthenticationSourceAdd, ctx.Doer, nil, source, "Created authentication source %s [%s].", source.Name, source.Type.String())
...
func EditAuthSourcePost(ctx *context.Context) {
	...
	audit.Record(ctx, audit.SystemAuthenticationSourceUpdate, ctx.Doer, nil, source, "Updated authentication source %s.", source.Name)
