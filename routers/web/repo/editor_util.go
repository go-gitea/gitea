...
func getContextRepoEditorConfig(ctx *context_service.Context, treePath string) string {
	def := getContextRepoEditorConfigDef(ctx, treePath)
	if def != nil {
...
// getContextRepoEditorConfigDef returns the editorconfig definition for given treePath or nil
func getContextRepoEditorConfigDef(ctx *context_service.Context, treePath string) *editorconfig.Definition {
