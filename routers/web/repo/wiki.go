...
func NewWikiPost(ctx *context.Context) {
	...
	notify.NewWikiPage(ctx, ctx.Doer, ctx.Repo.Repository, string(wikiName), form.Message)
...
func EditWikiPost(ctx *context.Context) {
	...
	notify.EditWikiPage(ctx, ctx.Doer, ctx.Repo.Repository, string(newWikiName), form.Message)
...
func DeleteWikiPagePost(ctx *context.Context) {
	...
	notify.DeleteWikiPage(ctx, ctx.Doer, ctx.Repo.Repository, string(wikiName))
