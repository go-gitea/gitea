...
func RegisterRoutes(m *web.Route) {
	...
	m.Group("/admin", func() {
		...
		m.Group("/hooks", func() {
			...
			m.Post("/teamcity/{id}", bindIgnErr(forms.NewMSTeamsHookForm{}), repo.TeamCityHooksEditPost)
		...
		m.Group("/{configType:default-hooks|system-hooks}", func() {
			...
			m.Post("/teamcity/new", bindIgnErr(forms.NewMSTeamsHookForm{}), repo.TeamCityHooksNewPost)
