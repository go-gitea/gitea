...
// LoadMailIcon loads an icon for inline embedding into mails, referenced via "cid:" URIs
// in mail templates. The files are generated by "make generate-images".
...
// mail clients strip svg, so the icons are raster images embedded via "cid:" references,
// with a unicode fallback for clients that block images
