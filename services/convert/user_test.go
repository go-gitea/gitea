...
func TestUser_ToUser(t *testing.T) {
	...
	apiUser = toUser(db.DefaultContext, user2, user1, perm.AccessModeNone)
	assert.False(t, apiUser.IsAdmin)

	apiUser = toUser(db.DefaultContext, user1, nil, perm.AccessModeNone)
	assert.False(t, apiUser.IsAdmin)
	...
	apiUser = toUser(db.DefaultContext, user31, user31, perm.AccessModeNone)
	assert.False(t, apiUser.IsAdmin)
