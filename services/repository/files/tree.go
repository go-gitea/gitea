...
func GetTreeBySHA(ctx context.Context, repo *models.Repository, gitRepo *git.Repository, sha string, page, perPage int, recursive bool) (*api.GitTreeResponse, error) {
