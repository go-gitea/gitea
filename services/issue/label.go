...
func ClearLabels(issue *issues_model.Issue, doer *user_model.User) error {
	...
	notify_service.NotifyIssueClearLabels(db.DefaultContext, doer, issue)
...
func AddLabel(issue *issues_model.Issue, doer *user_model.User, label *issues_model.Label) error {
	...
	notify_service.NotifyIssueChangeLabels(db.DefaultContext, doer, issue, []*issues_model.Label{label}, nil)
	return nil
}
...
func AddLabels(issue *issues_model.Issue, doer *user_model.User, labels []*issues_model.Label) error {
	...
	notify_service.NotifyIssueChangeLabels(db.DefaultContext, doer, issue, labels, nil)
	return nil
}
...
func RemoveLabel(issue *issues_model.Issue, doer *user_model.User, label *issues_model.Label) error {
	...
	notify_service.NotifyIssueChangeLabels(db.DefaultContext, doer, issue, nil, []*issues_model.Label{label})
	return nil
}
...
func ReplaceLabels(issue *issues_model.Issue, doer *user_model.User, labels []*issues_model.Label) error {
	...
	notify_service.NotifyIssueChangeLabels(db.DefaultContext, doer, issue, labels, old)
	return nil
}
