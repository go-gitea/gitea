...
func TestRenderHelperCodePreview(t *testing.T) {
	...
	<div class="code-preview-header">
		<a href="http://full" class="font-semibold" rel="nofollow">repo1/README.md</a>
		repo.code_preview_line_from_to:1,2,<a href="/user2/repo1/commit/65f1bf27bc3bf70f64657658635e66094edbcb4d" class="muted font-mono text-text" rel="nofollow">65f1bf27bc</a>
	</div>
...
`, string(htm))
	...
	<div class="code-preview-header">
		<a href="http://full" class="font-semibold" rel="nofollow">repo1/README.md</a>
		repo.code_preview_line_in:1,<a href="/user2/repo1/commit/65f1bf27bc3bf70f64657658635e66094edbcb4d" class="muted font-mono text-text" rel="nofollow">65f1bf27bc</a>
	</div>
	<table class="file-view">
		<tbody><tr>
				<td class="lines-num"><span data-line-number="1"></span></td>
