...
func TestCleanupSnapshotVersions(t *testing.T) {
	...
	originalRetainBuilds := setting.Packages.RetainMavenSnapshotBuilds
	originalDebugMode := setting.Packages.DebugMavenCleanup
	t.Cleanup(func() {
		setting.Packages.RetainMavenSnapshotBuilds = originalRetainBuilds
		setting.Packages.DebugMavenCleanup = originalDebugMode
	})
