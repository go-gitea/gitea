...
func TestPrepareWebhooks(t *testing.T) {
	...
	assert.NoError(t, PrepareWebhooks(repo, nil, models.HookEventPush, &api.PushPayload{Commits: []*api.PayloadCommit{{}}}))
	for _, hookTask := range hookTasks {
...
func TestPrepareWebhooksBranchFilterMatch(t *testing.T) {
	...
	assert.NoError(t, PrepareWebhooks(repo, nil, models.HookEventPush, &api.PushPayload{Ref: "refs/heads/feature/7791", Commits: []*api.PayloadCommit{{}}}))
	for _, hookTask := range hookTasks {
		models.AssertExistsAndLoadBean(t, hookTask)
	}
}
...
func TestPrepareWebhooksBranchFilterNoMatch(t *testing.T) {
	...
	assert.NoError(t, PrepareWebhooks(repo, nil, models.HookEventPush, &api.PushPayload{Ref: "refs/heads/fix_weird_bug"}))
