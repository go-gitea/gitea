...
func TestCreateUser(t *testing.T) {
	...
	assert.NoError(t, user_model.CreateUser(db.DefaultContext, user, &user_model.UserMeta{}))
...
func TestCreateUser_Issue5882(t *testing.T) {
	...
	for _, v := range tt {
		...
		assert.NoError(t, user_model.CreateUser(db.DefaultContext, v.user, &user_model.UserMeta{}))
