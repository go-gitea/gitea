...
import (
	...
	"code.gitea.io/gitea/internal/routers/api/packages/alpine"
	"code.gitea.io/gitea/internal/routers/api/packages/cargo"
	"code.gitea.io/gitea/internal/routers/api/packages/chef"
	"code.gitea.io/gitea/internal/routers/api/packages/composer"
	"code.gitea.io/gitea/internal/routers/api/packages/conan"
	"code.gitea.io/gitea/internal/routers/api/packages/conda"
	"code.gitea.io/gitea/internal/routers/api/packages/container"
	"code.gitea.io/gitea/internal/routers/api/packages/cran"
	"code.gitea.io/gitea/internal/routers/api/packages/debian"
	"code.gitea.io/gitea/internal/routers/api/packages/generic"
	"code.gitea.io/gitea/internal/routers/api/packages/goproxy"
	"code.gitea.io/gitea/internal/routers/api/packages/helm"
	"code.gitea.io/gitea/internal/routers/api/packages/maven"
	"code.gitea.io/gitea/internal/routers/api/packages/npm"
	"code.gitea.io/gitea/internal/routers/api/packages/nuget"
	"code.gitea.io/gitea/internal/routers/api/packages/pub"
	"code.gitea.io/gitea/internal/routers/api/packages/pypi"
	"code.gitea.io/gitea/internal/routers/api/packages/rpm"
	"code.gitea.io/gitea/internal/routers/api/packages/rubygems"
	"code.gitea.io/gitea/internal/routers/api/packages/swift"
	"code.gitea.io/gitea/internal/routers/api/packages/vagrant"
	"code.gitea.io/gitea/internal/services/auth"
	context_service "code.gitea.io/gitea/internal/services/context"
)
