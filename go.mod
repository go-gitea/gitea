...
replace github.com/nektos/act => gitea.com/gitea/act v0.261.7-0.20251003180512-ac6e4b751763 // gitea maintains its own package
...
replace gitlab.com/gitlab-org/api/client-go => gitlab.com/gitlab-org/api/client-go v0.142.4 // TODO: gitlab sdk api changes a lot, need more time to refactor and fix
