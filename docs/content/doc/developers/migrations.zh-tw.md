...
Gitea 定義了一些基本物件於套件 [pkgs/migrations/base](https://github.com/go-gitea/gitea/tree/master/pkgs/migrations/base)。  
...
您可以在 [downloader.go](https://github.com/go-gitea/gitea/blob/master/pkgs/migrations/base/downloader.go) 中找到這些介面。
...
您可以在 [uploader.go](https://github.com/go-gitea/gitea/blob/master/pkgs/migrations/base/uploader.go) 中找到這些介面。
