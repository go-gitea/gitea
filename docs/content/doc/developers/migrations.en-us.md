...
First of all, Gitea defines some standard objects in packages [pkgs/migrations/base](https://github.com/go-gitea/gitea/tree/main/pkgs/migrations/base).  
...
You can find these interfaces in [downloader.go](https://github.com/go-gitea/gitea/blob/main/pkgs/migrations/base/downloader.go).
...
You can find these interfaces in [uploader.go](https://github.com/go-gitea/gitea/blob/main/pkgs/migrations/base/uploader.go).
