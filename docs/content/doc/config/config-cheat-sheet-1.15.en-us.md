...
title: "Config Cheat Sheet 1.15"
slug: "config-cheat-sheet-1.15"
weight: 115
toc: false
draft: false
menu:
  sidebar:
    parent: "config"
    name: "Config Cheat Sheet 1.15"
    weight: 115
    identifier: "config-cheat-sheet-1.15"
---

# Configuration Cheat Sheet (1.15)
...
accurately recorded in [app.example.ini](https://github.com/go-gitea/gitea/blob/release/v1.15/custom/conf/app.example.ini).
