...
- `THEME_COLOR_META_TAG`: **\<empty\>**: Value of `theme-color` meta tag, used by Safari for browser chrome and out-of-viewport areas. Default is unset which uses body color.
