...
- `ALLOWED_HOST_LIST`: **external**: Default to `*` for 1.15.x, `external` for 1.16 and later. Webhook can only call allowed hosts for security reasons. Comma separated list.
  - Built-in networks:
