...
- `CERT_FILE`: **https/cert.pem**: Cert file path used for HTTPS. When chaining, the server certificate must come first. From 1.11 paths are relative to `CUSTOM_PATH`.
