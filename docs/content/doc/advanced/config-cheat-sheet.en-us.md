...
- `ALLOW_CROSS_REPOSITORY_DEPENDENCIES` : **true** Enable this to have the issue dependency search show issues from all repositories where the user is granted access. 
