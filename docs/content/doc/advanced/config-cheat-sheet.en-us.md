...
- `PASSWORD_COMPLEXITY`: **lower,upper,digit,spec**: Set character types for password complexity. Lack or misconfiguration enable the complexity check requirement. Values of options: 
