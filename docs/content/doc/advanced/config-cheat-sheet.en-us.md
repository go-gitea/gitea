...
- `DEFAULT_ACTIONS_URL`: **https://gitea.com**: Default address to get action plugins, e.g. the default value means downloading from "[https://gitea.com/actions/checkout](https://gitea.com/actions/checkout)" for "uses: actions/checkout@v3"
