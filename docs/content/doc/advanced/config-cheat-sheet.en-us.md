...
- `CHARSET`: **utf8**: For MySQL only, either "utf8" or "utf8mb4", default is "utf8". NOTICE: your MySQL InnoDB have to great than 5.6 if this is "utf8mb4" and Gitea will not check that
