...
inside the `custom` directory (see [Customizing Gitea]({{< relref "doc/administer/customizing-gitea.en-us.md" >}})).
...
Gitea normally starts. See [Customizing Gitea]({{< relref "doc/administer/customizing-gitea.en-us.md" >}}) for details.
