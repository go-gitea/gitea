...
There is no setting for password resets. It is considered "enabled" when a [mail service]({{< relref "doc/usage/email-setup.md" >}}) is configured, and "disabled" otherwise.
...
- As a **user** you can change it... 
  ...
  - By using the `Forgot Password` link if there is a configured [mail service]({{< relref "doc/usage/email-setup.md" >}}).
