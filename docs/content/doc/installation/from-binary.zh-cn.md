...
**提示：** `GITEA_WORK_DIR` 表示 Gitea 工作的路径。以下路径可以通过 [环境变量]({{< relref "doc/administer/environment-variables.zh-cn.md" >}}) 初始化。
...
建议您在更新之前进行[备份]({{< relref "doc/administer/backup-and-restore.zh-cn.md" >}})。
