...
**NOTE:** Many of the following directories can be configured using [Environment Variables]({{< relref "doc/administer/environment-variables.en-us.md" >}}) as well!
...
See the [command line documentation]({{< relref "doc/administer/command-line.en-us.md" >}}) for information on using `gitea generate secret`.
...
It is recommended that you make a [backup]({{< relref "doc/administer/backup-and-restore.en-us.md" >}}) before updating your installation.
