...
前端开发应遵循 [Guidelines for Frontend Development]({{ < 相关参考 "doc/develop/guidelines-frontend.en-us.md" > }})
...
并到 <a href = '{{ < relref "doc/administer/config-cheat-sheet.en-us.md" > }}'>配置备忘单</a>
