...
These unreferenced blobs get deleted by a [clean up job]({{< relref "doc/administer/config-cheat-sheet.en-us.md#cron---cleanup-expired-packages-croncleanup_packages" >}}).
...
The cleanup rules are part of the [clean up job]({{< relref "doc/administer/config-cheat-sheet.en-us.md#cron---cleanup-expired-packages-croncleanup_packages" >}}) and run periodically.
