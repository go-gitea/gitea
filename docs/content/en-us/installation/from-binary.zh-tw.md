...
**NOTE:** Many of the following directories can be configured using [Environment Variables]({{< relref "doc/advanced/environment-variables.zh-tw.md" >}}) as well!
...
See the [command line documentation]({{< relref "doc/usage/command-line.zh-tw.md" >}}) for information on using `gitea generate secret`.
...
See how to create [Linux service]({{< relref "run-as-service-in-ubuntu.zh-tw.md" >}})
...
It is recommended that you make a [backup]({{< relref "doc/usage/backup-and-restore.zh-tw.md" >}}) before updating your installation.
...
possible to [install from source]({{< relref "from-source.zh-tw.md" >}}), without including
SQLite support.
