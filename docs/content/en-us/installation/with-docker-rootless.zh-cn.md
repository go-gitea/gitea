...
Customization files described [here](https://docs.gitea.io/zh-cn/customizing-gitea/) should
...
To set required TOKEN and SECRET values, consider using Gitea's built-in [generate utility functions](https://docs.gitea.io/zh-cn/command-line/#generate).
