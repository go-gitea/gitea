...
Customization files described [here](https://docs.gitea.io/nl-nl/customizing-gitea/) should
...
We will do this by leveraging the [SSH AuthorizedKeysCommand](https://docs.gitea.io/nl-nl/command-line/#keys) to match the keys against those accepted by Gitea.
