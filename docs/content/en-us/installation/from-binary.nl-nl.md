...
**NOTE:** Many of the following directories can be configured using [Environment Variables]({{< relref "doc/advanced/environment-variables.nl-nl.md" >}}) as well!
...
See the [command line documentation]({{< relref "doc/usage/command-line.nl-nl.md" >}}) for information on using `gitea generate secret`.
...
See how to create [Linux service]({{< relref "run-as-service-in-ubuntu.nl-nl.md" >}})
...
It is recommended that you make a [backup]({{< relref "doc/usage/backup-and-restore.nl-nl.md" >}}) before updating your installation.
...
possible to [install from source]({{< relref "from-source.nl-nl.md" >}}), without including
SQLite support.
