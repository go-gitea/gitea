...
Customization files described [here](https://docs.gitea.io/fr-fr/customizing-gitea/) should
...
We will do this by leveraging the [SSH AuthorizedKeysCommand](https://docs.gitea.io/fr-fr/command-line/#keys) to match the keys against those accepted by Gitea.
