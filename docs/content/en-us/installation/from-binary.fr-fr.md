...
**NOTE:** Many of the following directories can be configured using [Environment Variables]({{< relref "doc/advanced/environment-variables.fr-fr.md" >}}) as well!
...
See the [command line documentation]({{< relref "doc/usage/command-line.fr-fr.md" >}}) for information on using `gitea generate secret`.
...
See how to create [Linux service]({{< relref "run-as-service-in-ubuntu.fr-fr.md" >}})
...
It is recommended that you make a [backup]({{< relref "doc/usage/backup-and-restore.fr-fr.md" >}}) before updating your installation.
...
possible to [install from source]({{< relref "from-source.fr-fr.md" >}}), without including
SQLite support.
