...
We will do this by leveraging the [SSH AuthorizedKeysCommand](https://docs.gitea.io/zh-cn/command-line/#keys) to match the keys against those accepted by Gitea.
