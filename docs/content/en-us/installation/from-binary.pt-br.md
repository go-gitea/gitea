...
**NOTE:** Many of the following directories can be configured using [Environment Variables]({{< relref "doc/advanced/environment-variables.pt-br.md" >}}) as well!
...
See the [command line documentation]({{< relref "doc/usage/command-line.pt-br.md" >}}) for information on using `gitea generate secret`.
...
See how to create [Linux service]({{< relref "run-as-service-in-ubuntu.pt-br.md" >}})
...
It is recommended that you make a [backup]({{< relref "doc/usage/backup-and-restore.pt-br.md" >}}) before updating your installation.
...
possible to [install from source]({{< relref "from-source.pt-br.md" >}}), without including
SQLite support.
