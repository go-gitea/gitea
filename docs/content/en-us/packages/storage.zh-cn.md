...
These unreferenced blobs get deleted by a [clean up job]({{< relref "doc/advanced/config-cheat-sheet.zh-cn.md#cron---cleanup-expired-packages-croncleanup_packages" >}}).
...
The cleanup rules are part of the [clean up job]({{< relref "doc/advanced/config-cheat-sheet.zh-cn.md#cron---cleanup-expired-packages-croncleanup_packages" >}}) and run periodically.
