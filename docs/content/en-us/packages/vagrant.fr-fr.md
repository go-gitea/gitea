...
If the registry is private you can pass your [personal access token]({{< relref "doc/developers/api-usage.fr-fr.md#authentication" >}}) in the `VAGRANT_CLOUD_TOKEN` environment variable.
