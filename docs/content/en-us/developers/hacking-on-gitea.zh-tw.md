...
Take a look at our
<a href='{{< relref "doc/installation/from-source.zh-tw.md" >}}'>instructions</a>
for <a href='{{< relref "doc/installation/from-source.zh-tw.md" >}}'>building
from source</a>.
...
Frontend development should follow [Guidelines for Frontend Development]({{< relref "doc/developers/guidelines-frontend.zh-tw.md" >}})
...
and to the
<a href='{{< relref "doc/advanced/config-cheat-sheet.zh-tw.md" >}}'>configuration cheat sheet</a>
found in `docs/content/doc/advanced/config-cheat-sheet.zh-tw.md`
