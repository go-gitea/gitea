...
Take a look at our
<a href='{{< relref "doc/installation/from-source.nl-nl.md" >}}'>instructions</a>
for <a href='{{< relref "doc/installation/from-source.nl-nl.md" >}}'>building
from source</a>.
...
Frontend development should follow [Guidelines for Frontend Development]({{< relref "doc/developers/guidelines-frontend.nl-nl.md" >}})
...
and to the
<a href='{{< relref "doc/advanced/config-cheat-sheet.nl-nl.md" >}}'>configuration cheat sheet</a>
found in `docs/content/doc/advanced/config-cheat-sheet.nl-nl.md`
