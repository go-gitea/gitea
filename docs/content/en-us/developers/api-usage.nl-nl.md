...
Sheet](https://docs.gitea.io/nl-nl/config-cheat-sheet/) for more
information.
...
Access tokens obtained from Gitea's [OAuth2 provider](https://docs.gitea.io/nl-nl/oauth2-provider) are accepted by these methods:
