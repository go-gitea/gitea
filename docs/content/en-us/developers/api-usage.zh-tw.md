...
Sheet](https://docs.gitea.io/zh-tw/config-cheat-sheet/) for more
information.
...
Access tokens obtained from Gitea's [OAuth2 provider](https://docs.gitea.io/zh-tw/oauth2-provider) are accepted by these methods:
