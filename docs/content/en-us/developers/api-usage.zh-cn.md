...
Sheet](https://docs.gitea.io/zh-cn/config-cheat-sheet/) for more
information.
...
Access tokens obtained from Gitea's [OAuth2 provider](https://docs.gitea.io/zh-cn/oauth2-provider) are accepted by these methods:
