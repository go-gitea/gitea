...
Take a look at our
<a href='{{< relref "doc/installation/from-source.zh-cn.md" >}}'>instructions</a>
for <a href='{{< relref "doc/installation/from-source.zh-cn.md" >}}'>building
from source</a>.
...
Frontend development should follow [Guidelines for Frontend Development]({{< relref "doc/developers/guidelines-frontend.zh-cn.md" >}})
...
and to the
<a href='{{< relref "doc/advanced/config-cheat-sheet.zh-cn.md" >}}'>configuration cheat sheet</a>
found in `docs/content/doc/advanced/config-cheat-sheet.zh-cn.md`
