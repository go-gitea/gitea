...
Take a look at our
<a href='{{< relref "doc/installation/from-source.pt-br.md" >}}'>instructions</a>
for <a href='{{< relref "doc/installation/from-source.pt-br.md" >}}'>building
from source</a>.
...
Frontend development should follow [Guidelines for Frontend Development]({{< relref "doc/developers/guidelines-frontend.pt-br.md" >}})
...
and to the
<a href='{{< relref "doc/advanced/config-cheat-sheet.pt-br.md" >}}'>configuration cheat sheet</a>
found in `docs/content/doc/advanced/config-cheat-sheet.pt-br.md`
