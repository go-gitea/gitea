...
Sheet](https://docs.gitea.io/pt-br/config-cheat-sheet/) for more
information.
...
Access tokens obtained from Gitea's [OAuth2 provider](https://docs.gitea.io/pt-br/oauth2-provider) are accepted by these methods:
