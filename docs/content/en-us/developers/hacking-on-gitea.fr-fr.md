...
Take a look at our
<a href='{{< relref "doc/installation/from-source.fr-fr.md" >}}'>instructions</a>
for <a href='{{< relref "doc/installation/from-source.fr-fr.md" >}}'>building
from source</a>.
...
Frontend development should follow [Guidelines for Frontend Development]({{< relref "doc/developers/guidelines-frontend.fr-fr.md" >}})
...
and to the
<a href='{{< relref "doc/advanced/config-cheat-sheet.fr-fr.md" >}}'>configuration cheat sheet</a>
found in `docs/content/doc/advanced/config-cheat-sheet.fr-fr.md`
