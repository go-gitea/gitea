...
Sheet](https://docs.gitea.io/fr-fr/config-cheat-sheet/) for more
information.
...
Access tokens obtained from Gitea's [OAuth2 provider](https://docs.gitea.io/fr-fr/oauth2-provider) are accepted by these methods:
