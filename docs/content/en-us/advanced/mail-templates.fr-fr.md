...
for these functions are located under the [`custom` directory](https://docs.gitea.io/fr-fr/customizing-gitea/).
...
Please check [Gitea's logs](https://docs.gitea.io/fr-fr/logging-configuration/) for error messages in case of trouble.
