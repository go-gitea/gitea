...
for these functions are located under the [`custom` directory](https://docs.gitea.io/nl-nl/customizing-gitea/).
...
Please check [Gitea's logs](https://docs.gitea.io/nl-nl/logging-configuration/) for error messages in case of trouble.
