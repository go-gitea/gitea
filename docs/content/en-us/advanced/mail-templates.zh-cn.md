...
for these functions are located under the [`custom` directory](https://docs.gitea.io/zh-cn/customizing-gitea/).
...
Please check [Gitea's logs](https://docs.gitea.io/zh-cn/logging-configuration/) for error messages in case of trouble.
