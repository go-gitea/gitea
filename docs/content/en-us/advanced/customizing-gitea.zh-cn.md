...
- [Quick Cheat Sheet](https://docs.gitea.io/zh-cn/config-cheat-sheet/)
...
- [List of Environment Variables](https://docs.gitea.io/zh-cn/environment-variables/)
...
For more information, see [Adding Legal Pages](https://docs.gitea.io/zh-cn/adding-legal-pages).
...
For more information, see the [labels documentation]({{< relref "doc/usage/labels.zh-cn.md" >}}).
...
The default theme can be changed via `DEFAULT_THEME` in the [ui](https://docs.gitea.io/zh-cn/config-cheat-sheet/#ui-ui) section of `app.ini`.

Gitea also has support for user themes, which means every user can select which theme should be used.
The list of themes a user can choose from can be configured with the `THEMES` value in the [ui](https://docs.gitea.io/zh-cn/config-cheat-sheet/#ui-ui) section of `app.ini`.
