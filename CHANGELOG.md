...
* ENHANCEMENTS
  ...
  * Remove package code.gitea.io/gitea/internal/modules/git import out of models (#11025)
...
* BUILD
  ...
  * Move code.gitea.io/git to code.gitea.io/gitea/internal/modules/git (#6364)
