...
* BUGFIXES
  ...
  * Re-enable creating default webhooks. (#24626)
...
* BUGFIXES
  ...
  * Refresh the reference of the closed PR when reopening (#24231) (#24587)
...
* BUGFIXES
  * Add force_merge to merge request and fix checking mergeable (#23010) (#23032)
...
* ENHANCEMENTS
  ...
  * Make repository file list usable on mobile (#19515)
...
* ENHANCEMENTS
  ...
  * Show 2FA info on Admin Panel: Users List (#12515)
...
* BUGFIXES
  * When deleting repository decrease user repository count in cache (#11954) (#12188)
...
* ENHANCEMENTS
  ...
  * Make static resources web browser cache time customized on app.ini (#8442)
...
* BUGFIXES
  ...
  * Fix milestone completeness calculation when migrating (#7725)
...
* MISC
  ...
  * [Branch View] show "New Pull Request" Button only if possible (#7977)
...
* ENHANCEMENTS
  ...
  * Make the version within makefile overwritable (#6080)
...
* SECURITY
  ...
  * Fix path cleanup in file editor, when initializing new repository and LFS oids  (#3871) (#3873)
...
* BUGFIXES
  ...
  * Recognize more characters in cross-referenced repo name (#3413)
...
* ENHANCEMENTS
  ...
  * Remove redundant functions and code (#2652)
  ...
  * Remove redundant CheckUnit calls in router (#2627)
  * Remove repo unit index (#2621)
  * Remove redundant issue LoadAttributes() calls (#2614)
