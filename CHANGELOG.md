...
## [1.22.0](https://github.com/go-gitea/gitea/releases/tag/v1.22.0) - 2024-05-23
...
* API
  ...
  * Enhance Actions Secrets Management API for repository (#30656)
  * Fix compare api swagger (#30648)
  * Refactor branch and tag existence checks (#30618)
  ...
  * Implement branch/commit comparison API (#30349)
...
* BUGFIXES
  ...
  * Fix: close file in the Upload func (#30262) (#30270)
