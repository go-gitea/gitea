...
* BUGFIXES
  * [API] Allow only specific Colums to be updated on Issue (#9539) (#9580)
  * Add ErrReactionAlreadyExist error (#9550) (#9564)
  * Fix bug when migrate from API (#8631) (#9563)
  * Use default avatar for ghost user (fix 500 error) (#9536) (#9537)
  ...
  * [API] Fix paging on /repos/{owner}/{repo}/git/trees/{sha} endpoint (#9482)
