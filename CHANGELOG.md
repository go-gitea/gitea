...
* FEATURES
  ...
  * Add api endpoint to fetch git notes (#16649)
...
* ENHANCEMENTS
  ...
  * Fork API accepts custom repository name (#18066)
  ...
  * fix: remove deprecated `extendDefaultPlugins` method of svgo (#17399)
