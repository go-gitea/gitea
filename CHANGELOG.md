...
## [1.11.0](https://github.com/go-gitea/gitea/releases/tag/v1.11.0) - 2020-01-07
* BREAKING
  * [code/refactor] remove unused endpoints (#9538)
...
* BUGFIXES
  ...
  * Re-implement semantic label images (#9607)
  ...
  * [BugFix] Dont trigger notification twice on issue assignee change (#9582)
  ...
  * Delete extra Matlab gitignore (#9479)
  ...
  * Some more AppSubUrl fixes (#8647)
  * Graceful fixes (#8645)
...
* ENHANCEMENT
  ...
  * [API] expose PR counter on Repo API (#9202)
...
* SECURITY
  * [UI] swagger UI: hide iretating search field (#9554)
...
* BUILD
  * [Vendor Update] gitea.com/macaron to 1.4.0 (#9608)
...
* DOCS
  ...
  * Changelog for 1.9.6 (#8967) (#8969) (#8970)
  ...
  * Docs: Added Docker fail2ban configuration. (#8642)
...
* MISC
  ...
  * Fix [API] Add language to user api (#9215)
  * [API] add release_counter to Repo API (#9214)
