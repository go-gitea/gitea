...
* API
  ...
  * Expose usefull General Repo settings settings (#11758)
  * Return error when Mirrors are globaly disabled and like to create one (#11757)
  * Provide diff and patch API endpoints (#11751)
  * Allow to create closed milestones (#11745)
  * Add language Statistics endpoint (#11737)
  * Add Endpoint to get GetGenneralUI Settings (#11735) & (#11854)
