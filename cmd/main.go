...
// cliHelpPrinterNew helps to print "DEFAULT CONFIGURATION" for the following cases ("-c" must appear before "help"):
// * ./gitea -c /dev/null -h
// * ./gitea -c /dev/null help
// * ./gitea web -c /dev/null -h
// * ./gitea web -c /dev/null help
