...
test-coverage-check:
	@$(GO) run build/gocoverage.go check coverage.all \
		...
		code.gitea.io/gitea/modules/cache=14.60% \
		...
		code.gitea.io/gitea/modules/doctor=20.87% \
		code.gitea.io/gitea/modules/emoji=85.11% \
		...
		code.gitea.io/gitea/modules/graceful=29.29% \
		...
		code.gitea.io/gitea/modules/process=40.28% \
		code.gitea.io/gitea/modules/proxy=21.43% \
		...
		code.gitea.io/gitea/modules/svg=96.15% \
		...
		code.gitea.io/gitea/modules/validation=80.12% \
		code.gitea.io/gitea/modules/watcher=0.00% \
		code.gitea.io/gitea/modules/web=76.76% \
		code.gitea.io/gitea/modules/webhook=13.79% \
		...
		code.gitea.io/gitea/routers/install=7.39% \
		...
		code.gitea.io/gitea/services/convert=74.80% \
		code.gitea.io/gitea/services/cron=61.44% \
		code.gitea.io/gitea/services/externalaccount=0.00% \
		code.gitea.io/gitea/services/forms=36.81% \
