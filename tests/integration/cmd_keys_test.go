	...
	onGiteaRun(t, func(*testing.T, *url.URL) {
		tests := []struct {
			...
			{"test_empty_2", []string{"keys", "-e", "git", "-u", "git", "-t", "test", "-k", "test"}, true, ""},
			{
				...
				false,
				"# gitea public key\ncommand=\"" + setting.AppPath + " --config=" + util.ShellEscape(setting.CustomConf) + " --work-path=" + util.ShellEscape(setting.AppWorkPath) + " serv key-1\",no-port-forwarding,no-X11-forwarding,no-agent-forwarding,no-pty,no-user-rc,restrict ssh-rsa  user2@localhost\n",
			},
