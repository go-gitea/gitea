...
func TestCreateFileOnProtectedBranch(t *testing.T) {
	onGiteaRun(t, func(t *testing.T, u *url.URL) {
		...
		// Change main branch to protected
		...
		assert.Contains(t, resp.Body.String(), "Cannot commit to protected branch &#34;main&#34;.")
...
func TestEditFile(t *testing.T) {
	onGiteaRun(t, func(t *testing.T, u *url.URL) {
		session := loginUser(t, "user2")
		testEditFile(t, session, "user2", "repo1", "main", "README.md", "Hello, World (Edited)\n")
	})
}
...
func TestEditFileToNewBranch(t *testing.T) {
	onGiteaRun(t, func(t *testing.T, u *url.URL) {
		session := loginUser(t, "user2")
		testEditFileToNewBranch(t, session, "user2", "repo1", "main", "feature/test", "README.md", "Hello, World (Edited)\n")
	})
}
