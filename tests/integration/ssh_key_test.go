...
func testPushDeployKeyOnEmptyRepo(t *testing.T, u *url.URL) {
	...
	ctxWithDeleteRepo := NewAPITestContext(t, "user2", "deploy-key-empty-repo-1", auth_model.AccessTokenScopeDeleteRepository, auth_model.AccessTokenScopeWriteUser)
...
func testKeyOnlyOneType(t *testing.T, u *url.URL) {
	...
	// OK login
	ctx := NewAPITestContext(t, username, reponame, auth_model.AccessTokenScopeWriteRepository, auth_model.AccessTokenScopeDeleteUser)
	ctxWithDeleteRepo := NewAPITestContext(t, username, reponame, auth_model.AccessTokenScopeDeleteRepository, auth_model.AccessTokenScopeWriteUser)
