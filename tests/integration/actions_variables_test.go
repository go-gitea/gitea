...
func TestActionsVariables(t *testing.T) {
	...
	_, _ = actions_model.InsertVariable(ctx, user2.ID, 0, 0, "VAR", "user2-var", "user2-var-description")
	...
	_, _ = actions_model.InsertVariable(ctx, org3.ID, 0, 0, "VAR", "org3-var", "org3-var-description")
	...
	_, _ = actions_model.InsertVariable(ctx, 0, repo1.ID, 0, "VAR", "repo1-var", "repo1-var-description")
	...
	_, _ = actions_model.InsertVariable(ctx, 0, 0, 0, "VAR", "global-var", "global-var-description")
