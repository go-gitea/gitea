...
func TestAPIListIssueComments(t *testing.T) {
	...
	token := getUserToken(t, repoOwner.Name, auth_model.AccessTokenScopeReadRepository)
...
func TestAPIDeleteComment(t *testing.T) {
	...
	token := getUserToken(t, repoOwner.Name, auth_model.AccessTokenScopeDeleteRepository)
