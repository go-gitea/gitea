...
func TestCreateRelease(t *testing.T) {
	...
	checkLatestReleaseAndCount(t, session, "/user2/repo1", "v0.0.1", translation.NewLocale("en-US").TrString("latest"), 4)
}
...
func TestCreateReleasePaging(t *testing.T) {
	...
	checkLatestReleaseAndCount(t, session2, "/user2/repo1", "v0.0.11", translation.NewLocale("en-US").TrString("latest"), 10)
}
