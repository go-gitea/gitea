...
func TestRepoCommitsWithStatus(t *testing.T) {
	...
	t.Run("pending", func(t *testing.T) { testRefMaster(t, "pending", "octicon-dot-fill", "text-yellow") })
	t.Run("success", func(t *testing.T) { testRefMaster(t, "success", "octicon-check", "text-green") })
	t.Run("error", func(t *testing.T) { testRefMaster(t, "error", "gitea-exclamation", "text-red") })
	t.Run("failure", func(t *testing.T) { testRefMaster(t, "failure", "octicon-x", "text-red") })
	t.Run("warning", func(t *testing.T) { testRefMaster(t, "warning", "gitea-exclamation", "text-yellow") })
