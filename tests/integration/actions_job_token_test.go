...
// 		t.Run("lfs-branch", doGitCheckoutBranch(dstPath, "--orphan", "lfs-branch"))

// 		doGitPull(dstPath, "-f")

// 		t.Run("delete master branch", doBranchDelete(httpContext, httpContext.Username, httpContext.Reponame, "master"))

// 		t.Run("new-branch", doGitPushTestRepository(dstPath))
